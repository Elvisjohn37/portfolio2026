                    ...
                    <div className="flex flex-col sm:flex-row mt-5 gap-3 sm:mt-10">
                        <div className="flex flex-col flex-1 gap-3 sm:gap-5">
                            ...
                            <Slide direction="right" in={inView} timeout={2000}>
                                <Typography>
                                    Highly skilled in leveraging pre-rendered
                                    and component-based frontend frameworks
                                    (such as React, Vue, and Next.js), as well
                                    as designing custom UI/UX solutions tailored
                                    to specific client needs. On the backend,
                                    experienced in developing and maintaining
                                    APIs, handling server-side logic, and
                                    managing databases to support complex,
